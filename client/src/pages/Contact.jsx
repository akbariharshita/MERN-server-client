                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4 flex flex-col">
                    ...
                    <textarea
                      ...
                      cols="50"
                      rows="6"
                      className="py-4 pl-9 bg-blue-100 mt-3 rounded-lg text-2xl"
                    ></textarea>
                  </div>
                  <button type="submit" className="hover:bg-blue-300 border-4 border-sky-300 rounded-full transition duration-300 py-4 px-3 mt-4 text-2xl font-semibold md:w-1/2 lg:w-1/3 xl:w-1/4">
                    Submit
                  </button>
                </form>
              </div>
