...
const Register = () => {
  ...
  return (
    <>
      <section>
        <main>
          <div className="section-registration bg-sky-200 min-h-screen flex items-center justify-center">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4 flex flex-col">
                    ...
                    <input
                      ...
                      className="input-field py-4 pl-9 bg-blue-100 mt-3 rounded-lg text-2xl"
                    />
                  </div>
                  <div className="mb-4 flex flex-col">
                  ...
                  <div className="mb-4 flex flex-col">
                    <label htmlFor="phone" className="text-xl md:text-base lg:text-3xl xl:text-5xl text-gray-800  font-semibold">
                      Phone
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="mb-4 flex flex-col">
                    <label htmlFor="password" className="text-xl md:text-base lg:text-3xl xl:text-5xl text-gray-800  font-semibold">
                      Password
                    </label>
                    <input
                      type="password"
                  ...
                  <button type="submit" className="hover:bg-blue-300 border-4 border-sky-300 rounded-full transition duration-300 py-4 px-3 text-2xl font-semibold md:w-1/2 lg:w-1/3 xl:w-1/4">
                    Register Now
                  </button>
                </form>
              </div>
